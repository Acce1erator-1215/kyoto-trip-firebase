    ...
    <div className="pb-40 px-5">
      ...
      <div className="space-y-6">
        {activeItems.map(item => (
           <div key={item.id} className="bg-white rounded-2xl shadow-washi border border-stone-100 overflow-hidden flex flex-col sm:flex-row group transition-all hover:shadow-luxury relative active:scale-[0.99] duration-200">
                    ...
                    <div className="space-y-6">
                        ...
                        <div>
                             ...
                             <input 
                                ...
                                className="w-full h-2 bg-stone-200 rounded-lg appearance-none cursor-pointer accent-wafu-indigo touch-none"
                             />
